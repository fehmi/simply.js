...
(function (global, factory) {
    ...
    function resolveRoute(context, params) {
      if (context.route.component) {
        document.querySelector("router").innerHTML = "<"+context.route.component+"></"+context.route.component+">";
        return {context, params};
      }      
      else if (typeof context.route.action === 'function') {
        console.log("resolveroute", context, params);
        console.log("resolveroute", context, params);
        console.log("resolveroute", context, params);
        console.log("resolveroute", context, params);
        console.log(document.querySelector("router"), context.route.component);
